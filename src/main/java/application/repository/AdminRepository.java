...
public class AdminRepository implements AdminRepositoryInterface {
    ...
    public Admin insert(CreateAdminDto user) throws SQLException {
        String sql = "INSERT INTO admins (fullName, email, personalNr, salted_hash, salt) VALUES (?,?,?, ?, ?)";
        ...
        return AdminRepository.getByEmail(user.getEmail());
    }
...
//    }
    ...
    public static Admin getByEmail(String email) throws SQLException {
