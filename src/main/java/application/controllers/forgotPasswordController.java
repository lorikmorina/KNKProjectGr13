    ...
    public  void changeLanguage() {
        ...
        languageToggleGroup.selectedToggleProperty().addListener((observable, oldToggle, newToggle) -> {
            if(newToggle == alButton) {
                ...
                newPassword.setPromptText(bundle.getString("newpassword.txt"));
                secQuestion2.setPromptText(bundle.getString("securityquesion.txt"));
                changeButton.setText(bundle.getString("changeButton.txt"));
                alrHaveAcc.setText(bundle.getString("alrHaveAcc.txt"));
